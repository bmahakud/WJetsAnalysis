...
TCanvas* c = new TCanvas("c","test",570,400);
  ...
  RooDataHist ds("ds","ds",mW,Import(*hist2)) ;
  ...
  RooRealVar sigma("sigma","sigma",10,5,25.0);
  ...
  RooRealVar frac0("frac0","frac0",0.25,0.1,0.7);
  ...
  */
  ...
  // pull 
  RooPlot* z1frame = mW.frame(Title("Wmass in 30< pt <60"));
  RooHist* hpull1 = frame->pullHist();
  z1frame->addPlotable(hpull1,"P");

  RooPlot* z2frame = mW.frame(Title("Wmass in 30< pt <60"));
